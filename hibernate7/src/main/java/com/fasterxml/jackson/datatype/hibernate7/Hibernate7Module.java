...
public class Hibernate7Module extends com.fasterxml.jackson.databind.Module
{
    ...
    public enum Feature {
	     ...
	     * <ul>
	     * <li>the {@link org.hibernate.type.MappingContext} is provided to the Hibernate7Module, or </li>
    ...
    public Hibernate7Module() {
        this(null, null);
    }

    public Hibernate7Module(MappingContext mapping) {
        this(mapping, null);
    }

    public Hibernate7Module(SessionFactory sessionFactory) {
        this(null, sessionFactory);
    }

    public Hibernate7Module(MappingContext mapping, SessionFactory sessionFactory) {
    ...
    protected AnnotationIntrospector annotationIntrospector() {
        Hibernate7AnnotationIntrospector ai = new Hibernate7AnnotationIntrospector();
    ...
    public Hibernate7Module enable(Feature f) {
        _moduleFeatures |= f.getMask();
        return this;
    }

    public Hibernate7Module disable(Feature f) {
        _moduleFeatures &= ~f.getMask();
        return this;
    }
    ...
    public Hibernate7Module configure(Feature f, boolean state) {
        if (state) {
            enable(f);
        } else {
            disable(f);
