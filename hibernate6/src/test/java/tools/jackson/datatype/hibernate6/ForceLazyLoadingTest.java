...
import tools.jackson.datatype.hibernate6.data.SimpleChild;
import tools.jackson.datatype.hibernate6.data.SimpleParent;
...
{
    private final static String DB_URL = "jdbc:h2:mem:lazyInit6;DB_CLOSE_DELAY=-1";

    private final static String EMPTY_DB_URL = "jdbc:h2:mem:lazyInitEmpty6;DB_CLOSE_DELAY=-1";
