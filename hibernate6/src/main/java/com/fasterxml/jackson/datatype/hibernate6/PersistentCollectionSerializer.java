    ...
    implements ContextualSerializer, ResolvableSerializer
{
        ...
        throws IOException
    {
        ...
        if (Hibernate6Module.Feature.REPLACE_PERSISTENT_COLLECTIONS.enabledIn(_features)) {
    ...
    protected Object findLazyValue(PersistentCollection coll) {
        ...
        if (!Hibernate6Module.Feature.FORCE_LAZY_LOADING.enabledIn(_features) && !coll.wasInitialized()) {
            return null;
        }
