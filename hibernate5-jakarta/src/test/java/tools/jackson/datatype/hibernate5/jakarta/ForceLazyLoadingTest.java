...
{
    private final static String DB_URL = "jdbc:h2:mem:lazyInit5j;DB_CLOSE_DELAY=-1";

    private final static String EMPTY_DB_URL = "jdbc:h2:mem:lazyInitEmpty5j;DB_CLOSE_DELAY=-1";
