...
public class Hibernate5JakartaModule extends com.fasterxml.jackson.databind.Module
{
    ...
    public Hibernate5JakartaModule() {
        this(null, null);
    }

    public Hibernate5JakartaModule(Mapping mapping) {
        this(mapping, null);
    }

    public Hibernate5JakartaModule(SessionFactory sessionFactory) {
        this(null, sessionFactory);
    }

    public Hibernate5JakartaModule(Mapping mapping, SessionFactory sessionFactory) {
    ...
    public Hibernate5JakartaModule enable(Feature f) {
        _moduleFeatures |= f.getMask();
        return this;
    }

    public Hibernate5JakartaModule disable(Feature f) {
        _moduleFeatures &= ~f.getMask();
        return this;
    }
    ...
    public Hibernate5JakartaModule configure(Feature f, boolean state) {
        if (state) {
            enable(f);
        } else {
            disable(f);
